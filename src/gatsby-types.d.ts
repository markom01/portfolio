...
type FileFieldsEnum =
  ...
  | 'childrenMdx.frontmatter.details'
...
type MdxFieldsEnum =
  ...
  | 'frontmatter.endDate'
  | 'frontmatter.icons'
  | 'frontmatter.icons.img.absolutePath'
  | 'frontmatter.icons.img.accessTime'
  | 'frontmatter.icons.img.atime'
  | 'frontmatter.icons.img.atimeMs'
  | 'frontmatter.icons.img.base'
  | 'frontmatter.icons.img.birthTime'
  | 'frontmatter.icons.img.birthtime'
  | 'frontmatter.icons.img.birthtimeMs'
  | 'frontmatter.icons.img.blksize'
  | 'frontmatter.icons.img.blocks'
  | 'frontmatter.icons.img.changeTime'
  | 'frontmatter.icons.img.children'
  | 'frontmatter.icons.img.childrenImageSharp'
  | 'frontmatter.icons.img.childrenMdx'
  | 'frontmatter.icons.img.ctime'
  | 'frontmatter.icons.img.ctimeMs'
  | 'frontmatter.icons.img.dev'
  | 'frontmatter.icons.img.dir'
  | 'frontmatter.icons.img.ext'
  | 'frontmatter.icons.img.extension'
  | 'frontmatter.icons.img.gid'
  | 'frontmatter.icons.img.id'
  | 'frontmatter.icons.img.ino'
  | 'frontmatter.icons.img.mode'
  | 'frontmatter.icons.img.modifiedTime'
  | 'frontmatter.icons.img.mtime'
  | 'frontmatter.icons.img.mtimeMs'
  | 'frontmatter.icons.img.name'
  | 'frontmatter.icons.img.nlink'
  | 'frontmatter.icons.img.prettySize'
  | 'frontmatter.icons.img.publicURL'
  | 'frontmatter.icons.img.rdev'
  | 'frontmatter.icons.img.relativeDirectory'
  | 'frontmatter.icons.img.relativePath'
  | 'frontmatter.icons.img.root'
  | 'frontmatter.icons.img.size'
  | 'frontmatter.icons.img.sourceInstanceName'
  ...
  | 'frontmatter.techStack.img.atime'
  | 'frontmatter.techStack.img.atimeMs'
  | 'frontmatter.techStack.img.base'
  | 'frontmatter.techStack.img.birthTime'
  | 'frontmatter.techStack.img.birthtime'
  | 'frontmatter.techStack.img.birthtimeMs'
  | 'frontmatter.techStack.img.blksize'
  | 'frontmatter.techStack.img.blocks'
  | 'frontmatter.techStack.img.changeTime'
  | 'frontmatter.techStack.img.children'
  | 'frontmatter.techStack.img.childrenImageSharp'
  | 'frontmatter.techStack.img.childrenMdx'
  | 'frontmatter.techStack.img.ctime'
  | 'frontmatter.techStack.img.ctimeMs'
  | 'frontmatter.techStack.img.dev'
  | 'frontmatter.techStack.img.dir'
  | 'frontmatter.techStack.img.ext'
  | 'frontmatter.techStack.img.extension'
  | 'frontmatter.techStack.img.gid'
  | 'frontmatter.techStack.img.id'
  | 'frontmatter.techStack.img.ino'
  | 'frontmatter.techStack.img.mode'
  | 'frontmatter.techStack.img.modifiedTime'
  | 'frontmatter.techStack.img.mtime'
  | 'frontmatter.techStack.img.mtimeMs'
  | 'frontmatter.techStack.img.name'
  | 'frontmatter.techStack.img.nlink'
  | 'frontmatter.techStack.img.prettySize'
  | 'frontmatter.techStack.img.publicURL'
  | 'frontmatter.techStack.img.rdev'
  | 'frontmatter.techStack.img.relativeDirectory'
  | 'frontmatter.techStack.img.relativePath'
  | 'frontmatter.techStack.img.root'
  | 'frontmatter.techStack.img.size'
  | 'frontmatter.techStack.img.sourceInstanceName'
  | 'frontmatter.techStack.img.uid'
  | 'frontmatter.techStack.name'
...
type MdxFrontmatterIcons = {
  readonly img: Maybe<File>;
  readonly name: Maybe<Scalars['String']>;
};

type MdxFrontmatterIconsFilterInput = {
  readonly img: InputMaybe<FileFilterInput>;
  readonly name: InputMaybe<StringQueryOperatorInput>;
};

type MdxFrontmatterIconsFilterListInput = {
  readonly elemMatch: InputMaybe<MdxFrontmatterIconsFilterInput>;
};
...
type MdxFrontmatterSkillsFilterListInput = {
  readonly elemMatch: InputMaybe<MdxFrontmatterSkillsFilterInput>;
};

type MdxFrontmatterTechStack = {
  readonly img: Maybe<File>;
  readonly name: Maybe<Scalars['String']>;
};

type MdxFrontmatterTechStackFilterInput = {
  readonly img: InputMaybe<FileFilterInput>;
  readonly name: InputMaybe<StringQueryOperatorInput>;
};

type MdxFrontmatterTechStackFilterListInput = {
  readonly elemMatch: InputMaybe<MdxFrontmatterTechStackFilterInput>;
};
...
type ExperienceQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly startDate: string | null, readonly endDate: string | null, readonly link: string | null, readonly role: string | null, readonly tasks: ReadonlyArray<string | null> | null, readonly skills: ReadonlyArray<{ readonly icon: string | null, readonly name: string | null } | null> | null, readonly logo: { readonly publicURL: string | null } | null } | null }> } };

type FilterQueryVariables = Exact<{ [key: string]: never; }>;


type FilterQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly icons: ReadonlyArray<{ readonly name: string | null, readonly img: { readonly publicURL: string | null } | null } | null> | null } | null }> } };
...
type ProjectsQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly startDate: string | null, readonly endDate: string | null, readonly link: string | null, readonly title: string | null, readonly description: string | null, readonly details: string | null, readonly techStack: ReadonlyArray<{ readonly name: string | null, readonly img: { readonly publicURL: string | null } | null } | null> | null, readonly thumbnail: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null }> } };
